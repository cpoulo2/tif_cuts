...
# Add a sidebar with methodology
    ...
    with school_tab:
        ...
        if selected_schools != []:
            ...
            if n == 1:
                st.markdown(f"""**{schools_filtered['School Name'].iloc[0]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{schools_filtered['Number of Students'].iloc[0]}** students of which **{schools_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""",unsafe_allow_html=True)
            elif n == 2:
                st.markdown(f"""**{schools_filtered['School Name'].iloc[0]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{schools_filtered['Number of Students'].iloc[0]}** students of which **{schools_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[1]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[1]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[1]} positions** affecting **{schools_filtered['Number of Students'].iloc[1]}** students of which **{schools_filtered['Percent Non-White'].iloc[1]:.0%}** are non-white.
""",unsafe_allow_html=True)
            elif n == 3:
                st.markdown(f"""**{schools_filtered['School Name'].iloc[0]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{schools_filtered['Number of Students'].iloc[0]}** students of which **{schools_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[1]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[1]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[1]} positions** affecting **{schools_filtered['Number of Students'].iloc[1]}** students of which **{schools_filtered['Percent Non-White'].iloc[1]:.0%}** are non-white.
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[2]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[2]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[2]} positions** affecting **{schools_filtered['Number of Students'].iloc[2]}** students of which **{schools_filtered['Percent Non-White'].iloc[2]:.0%}** are non-white.
""",unsafe_allow_html=True)
            elif n == 4:
                st.markdown(f"""**{schools_filtered['School Name'].iloc[0]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{schools_filtered['Number of Students'].iloc[0]}** students of which **{schools_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""",unsafe_allow_html=True)            
...
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[2]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[2]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[2]} positions** affecting **{schools_filtered['Number of Students'].iloc[2]}** students of which **{schools_filtered['Percent Non-White'].iloc[2]:.0%}** are non-white.
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[3]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[3]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[3]} positions** affecting **{schools_filtered['Number of Students'].iloc[3]}** students of which **{schools_filtered['Percent Non-White'].iloc[3]:.0%}** are non-white.
""",unsafe_allow_html=True)
            elif n == 5:
                st.markdown(f"""**{schools_filtered['School Name'].iloc[0]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{schools_filtered['Number of Students'].iloc[0]}** students of which **{schools_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""",unsafe_allow_html=True)            
...
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[3]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[3]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[3]} positions** affecting **{schools_filtered['Number of Students'].iloc[3]}** students of which **{schools_filtered['Percent Non-White'].iloc[3]:.0%}** are non-white.
""",unsafe_allow_html=True)
                st.markdown(f"""**{schools_filtered['School Name'].iloc[4]}** will stand to lose **${schools_filtered['TIF Surplus ($387m)'].iloc[4]:,.0f}** and **{schools_filtered['Mid Year Cuts'].iloc[4]} positions** affecting **{schools_filtered['Number of Students'].iloc[4]}** students of which **{schools_filtered['Percent Non-White'].iloc[4]:.0%}** are non-white.
""",unsafe_allow_html=True)
    ...
    with ward_tab:
        ...
        st.markdown(f"""<b>{alder}'s Ward</b> ({ward}) will stand to lose **${ward_filtered['TIF Surplus ($387m)'].iloc[0]:,.0f}** and **{ward_filtered['Mid Year Cuts'].iloc[0]} positions** affecting **{ward_filtered['Number of Students'].iloc[0]}** students of which **{ward_filtered['Percent Non-White'].iloc[0]:.0%}** are non-white.
""", unsafe_allow_html=True)
